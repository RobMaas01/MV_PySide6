...
class SettingsTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        desc = QLabel(
            ...
            'onderhoudsstatus van NH90-helikopters.<br><br>'
        ...
        arch = QLabel(
            ...
            '&nbsp;&nbsp;&bull; <code>processor.py</code> - transformaties en domeinlogica<br>'
            '&nbsp;&nbsp;&bull; <code>app_state_service.py</code> - service-laag voor user/system state<br><br>'
        ...
        dev = QLabel(
            ...
            '<span style="color:#64748b;">Wordt door de app beheerd; handmatig aanpassen tijdens runtime wordt afgeraden.</span>'
            '</td></tr>'
